...
<head>
    ...
    <title>TCars - Painel Admin</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="">TCars</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="edita_produtos.php">Editar Produtos</a>
                    <a class="nav-link" href="edita_cadastro.php">Editar Cadastros</a>
